        ...
        <div className="anime-detail">
            <div className="grid">
                <div className="col-4 text-center">
                    <img className='img-detail' src={allData.data.images.jpg.image_url} alt="Image Text" />
                    <div className='rating'>
                        <p>Rating</p>
                        <span className='rating-point'>{allData.data.score ? `${allData.data.score}/10` : '--/10'}</span>
